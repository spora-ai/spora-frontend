  ...
  routes: [
    ...
    authRoute('/groups', 'groups', () => import('@/pages/MyGroupsPage.vue')),
    {
      ...
      children: [
        ...
        { path: 'speech', name: 'settings-speech', component: () => import('@/pages/settings/SpeechProviderConfigsPage.vue'), props: { scope: 'user' } },
        ...
        { path: 'admin/speech-providers', name: 'settings-admin-speech-providers', component: () => import('@/pages/settings/SpeechProviderConfigsPage.vue'), props: { scope: 'global' } },
      ],
    },
