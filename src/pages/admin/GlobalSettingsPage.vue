          ...
          <section class="mb-10">
            ...
            >
              ...
              >
                ...
                <ToolSettingsForm
                  :tool="{ tool_class: driver.driver_class, tool_name: driver.name, display_name: driver.display_name, description: '', category: '', settings_schema: driver.settings_schema, operations: [], recommends_skills: [] }"
