...
<template>
  <div class="min-h-screen bg-background flex flex-col">
    <main class="flex-1 px-4 py-8">
      <div class="max-w-2xl mx-auto">
        ...
        <MailTemplateEditorView
          ...
          @update:body-text="(v) => (editor.editorForm.value.body = v)"
          @update:body-html="(v) => (editor.editorForm.value.body_html = v)"
    ...
    <MailTemplateCreateModal
      ...
      @update:body-text="(v) => (editor.createForm.value.body = v)"
      @update:body-html="(v) => (editor.createForm.value.body_html = v)"
